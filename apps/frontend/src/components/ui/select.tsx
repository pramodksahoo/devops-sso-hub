...
>(({ className, children, variant = 'default', size = 'default', ...props }, ref) => {
  const variantClasses = {
    default: "bg-background border border-input text-foreground shadow-soft hover:shadow-medium",
    outline: "bg-background border-2 border-input text-foreground shadow-soft hover:shadow-medium",
    ghost: "bg-transparent border-none text-foreground hover:bg-muted/50",
  }
  ...
  return (
    <SelectPrimitive.Trigger
      ref={ref}
      className={cn(
        "flex w-full items-center justify-between rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1",
